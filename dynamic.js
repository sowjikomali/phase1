...
function carrier(ca){
   ...
   function education(edu){
    ...
    table.border="2";
    var tr1="<tr><th>degree</th><th>institute</th><th>pre</th><th>yop</th></tr>";
    var tr2="";
    for(var i=0;i<edu.length;i++){
    	// tr2=tr2+"<tr><td>"+edu[i].degree+"</td><td>"+edu.[i]institute+"</td><td>"+edu[i].pre+"</td><td>"+edu[i].yop</tr>"
    	tr2=tr2+"<tr><td>"+edu[i].degree+"</td><td>"+edu[i].institute+"</td><td>"+edu[i].pre+"</td><td>"+edu[i].yop+"</td><tr>";
    }
